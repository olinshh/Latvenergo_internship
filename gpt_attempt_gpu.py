...
path = Path(r"C:\\Users\viest\OneDrive\Desktop\latvenergo_projekts\archive_ok.json")
...
print(data[0:5])
data = data[:5000] # limitēju datus, lai ātrāk trenētos
...
encoded_data = torch.tensor(encoded_data, dtype = torch.long) # converting my list of integers of data to a tensor
...
m_generate = m.generate(idx = torch.zeros((1,1), dtype = torch.long), max_new_tokens = 100)[0].tolist()
print("m_generate: ")
